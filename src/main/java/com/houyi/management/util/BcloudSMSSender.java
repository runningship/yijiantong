...
public class BcloudSMSSender {
	...
	public static String doSendVerifyCode(String tel , String code){
		...
		try {
			String returnString = BcloudSMSSender.batchSend(url, account, pswd, tel, msg, needstatus, product, extno);
			return returnString;
		} catch (Exception e) {
			e.printStackTrace();
		}
